...
function ajax_register(){
	...
	if(document.getElementsByName("graduate_date")[0].value ==""){
		...
		/*graduate_year = document.getElementsByName("graduate_date")[0].value.split('-')[0];
		graduate_month = document.getElementsByName("graduate_date")[0].value.split('-')[1];
		if(new Date(graduate_year, graduate_month, "01").getTime() > new Date().getTime()){
			document.getElementsByName("message_graduate_date")[0].style.display = "inline";
			document.getElementsByName("message_graduate_date")[0].innerHTML = "Graduation date should be earlier than today";
			count++;
		}else{
